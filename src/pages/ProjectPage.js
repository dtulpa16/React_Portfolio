  ...
  return (
    <div>
      ...
      <div class="flex flex-wrap justify-center text-center items-center gap-6 mt-20">
        <div class="h-250 min-h-[266px] transition-all duration-100 hover:scale-105 cursor-pointer p-3 w-72 rounded-md gap-4 bg-white flex flex-col justify-center items-center mt-10">
          ...
          <h1 class="text-black text-sm font-semibold min-h-[120px]">
        ...
        <div class="h-250 min-h-[266px] transition-all duration-100 hover:scale-105 cursor-pointer p-3 w-72 rounded-md gap-4 bg-white flex flex-col justify-center items-center mt-10">
          ...
          <h1 class="text-black text-xs font-semibold min-h-[120px]">
